...
class PasswordException extends Exception{
	void Message(){
		System.out.println("The password must be atleast 5 characters long and atmost 12 characters long");
		System.out.println("It should have at least one capital letter,one small letter"+"\n"+"one numeric value and one special character");
	}
}
